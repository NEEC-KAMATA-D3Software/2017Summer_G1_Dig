...
namespace Dig
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            sceneManager.Add(SceneType.Operation, new SceneFader(new Operation(gameDevice)));
            sceneManager.Add(SceneType.GamePlay, new SceneFader(new GamePlay(gameDevice)));
            sceneManager.Add(SceneType.GameClear, new SceneFader(new GameClear(gameDevice)));
            sceneManager.Add(SceneType.GameOver, new SceneFader(new GameOver(gameDevice)));
        ...
        protected override void LoadContent()
        {
            ...
            renderer.LoadTexture("loadback", "./Texture/");
            //1ピクセルの画像
